...
//! and ID/session token generation utilities.
...
pub use id::{
    EntityPrefix, generate_game_id, generate_guess_id, generate_oauth_id, generate_round_id,
    generate_session_id, generate_user_id, parse_prefix,
};
